function [Len,SF,FS]=DubinsLR(R0,x0,y0,phi0,R1,x1,y1,phi1,sign)
%% 逆时针起始圆+顺时针终止圆
% 逆时针起始圆
...
Len=sqrt((SF(1)-FS(1))^2+(SF(2)-FS(2))^2)+ArcLen(R0,phi0-pi/2,Theta-Alpha)+ArcLen(R1,phi1+pi/2,Theta-Alpha+pi);